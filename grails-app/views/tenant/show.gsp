...
<html>
    ...
    <body>
        ...
        <div id="show-tenant" class="content scaffold-show" role="main">
            ...
            <f:display bean="tenant" />
            <g:form resource="${this.tenant}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tenant}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
